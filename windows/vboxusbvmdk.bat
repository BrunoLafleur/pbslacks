...
echo Permet d'installer un systeme a partir d'une cle USB.
...
echo %filename% sera a utiliser en premier lors de la creation de la machine virtuelle.
echo Il a comme numero de device le %numdev%.
